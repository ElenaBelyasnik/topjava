...
<div class="modal fade" tabindex="-1" id="editRow">
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            <form id="detailsForm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="description" name="" placeholder="<spring:message code="meal.description"/>">
                </div>
                <div class="form-group">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dissmis="modal" onclick="colseNoty()">
