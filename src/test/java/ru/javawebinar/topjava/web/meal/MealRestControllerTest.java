...
class MealRestControllerTest extends AbstractControllerTest {
    ...
    void createInvalidMeal() throws Exception {
        Meal invalidMeal = new Meal(null, null, "anyMeal", 200);
    ...
    @Test
    void createValidMeal() throws Exception {
        Meal invalidMeal = new Meal(MEAL1_ID, null, null, 3000);
    ...
    void createDuplicateDateTime() throws Exception {
        Meal invalidCrMeal = new Meal(null, adminMeal1.getDateTime(), "anyMeal", 1000);
        perform(MockMvcRequestBuilders.post(REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
                .content(JsonUtil.writeValue(invalidCrMeal))
                .with(userHttpBasic(admin)))
                .andDo(print())
    ...
    void updateDuplicateDateTime() throws Exception {
        Meal invalidUpdMeal = new Meal(MEAL1_ID, meal2.getDateTime(), "anyMeal", 1000);
        perform(MockMvcRequestBuilders.put(REST_URL + MEAL1_ID)
                .contentType(MediaType.APPLICATION_JSON)
                .content(JsonUtil.writeValue(invalidUpdMeal))
                .with(userHttpBasic(user)))
                .andDo(print())
                .andExpect(status().isConflict())
                .andExpect(errorType(VALIDATION_ERROR))
